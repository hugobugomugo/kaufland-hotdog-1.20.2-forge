...
public class WorldOpenFlows {
   ...
   public void loadLevel(Screen p_233134_, String p_233135_) {
      try {
         ...
         System.gc();
         String s = "Ran out of memory trying to read level data of world folder \"" + p_233135_ + "\"";
         ...
         crashreportcategory.setDetail("World folder", p_233135_);
   ...
   private LevelStorageSource.LevelStorageAccess createWorldAccess(String p_233156_) {
      try {
         ...
         this.minecraft.setScreen(NoticeWithLinkScreen.createWorldSymlinkWarningScreen((Screen)null));
         return null;
      }
   }
