...
public class ItemProperties {
   ...
   static {
      ...
      ClampedItemPropertyFunction clampeditempropertyfunction = (p_296288_, p_296289_, p_296290_, p_296291_) -> {
         if (!p_296288_.is(ItemTags.TRIMMABLE_ARMOR)) {
            return Float.NEGATIVE_INFINITY;
         } else {
            return p_296289_ == null ? 0.0F : ArmorTrim.getTrim(p_296289_.registryAccess(), p_296288_, true).map(ArmorTrim::material).map(Holder::value).map(TrimMaterial::itemModelIndex).orElse(0.0F);
         }
      };
