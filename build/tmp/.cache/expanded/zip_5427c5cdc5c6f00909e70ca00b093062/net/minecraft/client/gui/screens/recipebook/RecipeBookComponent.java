...
public class RecipeBookComponent implements PlaceRecipe<Ingredient>, Renderable, GuiEventListener, NarratableEntry, RecipeShownListener {
   ...
   private void updateCollections(boolean p_100383_) {
      ...
      list.forEach((p_296197_) -> {
         p_296197_.canCraft(this.stackedContents, this.menu.getGridWidth(), this.menu.getGridHeight(), this.book);
      });
      ...
      if (!s.isEmpty()) {
         ...
         list1.removeIf((p_301525_) -> {
            return !objectset.contains(p_301525_);
         });
      }
