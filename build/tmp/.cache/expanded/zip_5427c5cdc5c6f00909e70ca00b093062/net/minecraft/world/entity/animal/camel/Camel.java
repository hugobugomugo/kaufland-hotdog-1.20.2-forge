...
public class Camel extends AbstractHorse implements PlayerRideableJumping, Saddleable {
   ...
   protected float getStandingEyeHeight(Pose p_248908_, EntityDimensions p_250490_) {
      return p_250490_.height - 0.1F * this.getScale();
   }
   ...
   protected Vector3f getPassengerAttachmentPoint(Entity p_298535_, EntityDimensions p_298993_, float p_301011_) {
      ...
      boolean flag = i == 0;
      float f = 0.5F;
      float f1 = (float)(this.isRemoved() ? (double)0.01F : this.getBodyAnchorAnimationYOffset(flag, 0.0F, p_298993_, p_301011_));
      ...
      return new Vector3f(0.0F, f1, f * p_301011_);
   }
   ...
   public Vec3 getLeashOffset(float p_251477_) {
      ...
      return new Vec3(0.0D, this.getBodyAnchorAnimationYOffset(true, p_251477_, entitydimensions, f) - (double)(0.2F * f), (double)(entitydimensions.width * 0.56F));
   }
