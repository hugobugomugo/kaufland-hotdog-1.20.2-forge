...
public class PiglinAi {
   ...
   public static void angerNearbyPiglins(Player p_34874_, boolean p_34875_) {
      ...
      list.stream().filter(PiglinAi::isIdle).filter((p_34881_) -> {
         ...
         if (p_296838_.level().getGameRules().getBoolean(GameRules.RULE_UNIVERSAL_ANGER)) {
            setAngerTargetToNearestTargetablePlayerIfFound(p_296838_, p_34874_);
         } else {
            setAngerTarget(p_296838_, p_34874_);
         }
   ...
   protected static void wasHurtBy(Piglin p_34838_, LivingEntity p_34839_) {
      if (!(p_34839_ instanceof Piglin)) {
         ...
         getAvoidTarget(p_34838_).ifPresent((p_296834_) -> {
            if (p_296834_.getType() != p_34839_.getType()) {
   ...
   private static BehaviorControl<LivingEntity> babySometimesRideBabyHoglin() {
      ...
      return CopyMemoryWithExpiry.create((p_296840_) -> {
         return p_296840_.isBaby() && setentitylooktargetsometimes$ticker.tickDownAndCheck(p_296840_.level().random);
   ...
   protected static void broadcastAngerTarget(AbstractPiglin p_34896_, LivingEntity p_34897_) {
      getAdultPiglins(p_34896_).forEach((p_296836_) -> {
         if (p_34897_.getType() != EntityType.HOGLIN || p_296836_.canHunt() && ((Hoglin)p_34897_).canBeHunted()) {
            setAngerTargetIfCloserThanCurrent(p_296836_, p_34897_);
         }
      });
   }
