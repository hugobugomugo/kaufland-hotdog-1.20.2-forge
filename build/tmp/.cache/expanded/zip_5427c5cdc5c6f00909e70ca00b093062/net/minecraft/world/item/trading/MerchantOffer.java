...
public class MerchantOffer {
   ...
   private MerchantOffer(MerchantOffer p_301741_) {
      this.baseCostA = p_301741_.baseCostA.copy();
      this.costB = p_301741_.costB.copy();
      this.result = p_301741_.result.copy();
      this.uses = p_301741_.uses;
      this.maxUses = p_301741_.maxUses;
      this.rewardExp = p_301741_.rewardExp;
      this.specialPriceDiff = p_301741_.specialPriceDiff;
      this.demand = p_301741_.demand;
      this.priceMultiplier = p_301741_.priceMultiplier;
      this.xp = p_301741_.xp;
   }
