...
public class Sheep extends Animal implements Shearable, net.minecraftforge.common.IForgeShearable {
   ...
   private DyeColor getOffspringColor(Animal p_29824_, Animal p_29825_) {
      ...
      return this.level().getRecipeManager().getRecipeFor(RecipeType.CRAFTING, craftingcontainer, this.level()).map((p_296805_) -> {
         return p_296805_.value().assemble(craftingcontainer, this.level().registryAccess());
