...
public class BeaconMenu extends AbstractContainerMenu {
   ...
   public static int encodeEffect(@Nullable MobEffect p_298242_) {
      return p_298242_ == null ? 0 : BuiltInRegistries.MOB_EFFECT.getId(p_298242_) + 1;
   }

   @Nullable
   public static MobEffect decodeEffect(int p_297542_) {
      return p_297542_ == 0 ? null : BuiltInRegistries.MOB_EFFECT.byId(p_297542_ - 1);
   }
   ...
   public void updateEffects(Optional<MobEffect> p_219973_, Optional<MobEffect> p_219974_) {
      if (this.paymentSlot.hasItem()) {
         this.beaconData.set(1, encodeEffect(p_219973_.orElse((MobEffect)null)));
         this.beaconData.set(2, encodeEffect(p_219974_.orElse((MobEffect)null)));
