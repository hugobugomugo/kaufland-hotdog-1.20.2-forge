...
public class InventoryMenu extends RecipeBookMenu<CraftingContainer> {
   ...
   public InventoryMenu(Inventory p_39706_, boolean p_39707_, final Player p_39708_) {
      ...
      for(int k = 0; k < 4; ++k) {
         ...
         this.addSlot(new Slot(p_39706_, 39 - k, 8, 8 + k * 18) {
            public void setByPlayer(ItemStack p_270969_, ItemStack p_299540_) {
               InventoryMenu.onEquipItem(p_39708_, equipmentslot, p_270969_, p_299540_);
      ...
      this.addSlot(new Slot(p_39706_, 40, 77, 62) {
         public void setByPlayer(ItemStack p_270479_, ItemStack p_301135_) {
            InventoryMenu.onEquipItem(p_39708_, EquipmentSlot.OFFHAND, p_270479_, p_301135_);
   ...
   public boolean recipeMatches(RecipeHolder<? extends Recipe<CraftingContainer>> p_299815_) {
      return p_299815_.value().matches(this.craftSlots, this.owner.level());
   }
