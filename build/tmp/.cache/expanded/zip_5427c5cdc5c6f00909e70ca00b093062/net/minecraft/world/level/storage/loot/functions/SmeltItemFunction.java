...
public class SmeltItemFunction extends LootItemConditionalFunction {
   ...
   public ItemStack run(ItemStack p_81268_, LootContext p_81269_) {
      if (p_81268_.isEmpty()) {
         ...
         Optional<RecipeHolder<SmeltingRecipe>> optional = p_81269_.getLevel().getRecipeManager().getRecipeFor(RecipeType.SMELTING, new SimpleContainer(p_81268_), p_81269_.getLevel());
