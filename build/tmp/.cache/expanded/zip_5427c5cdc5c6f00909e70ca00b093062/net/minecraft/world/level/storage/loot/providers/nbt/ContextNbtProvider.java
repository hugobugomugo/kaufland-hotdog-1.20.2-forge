...
public class ContextNbtProvider implements NbtProvider {
   ...
   public static final Codec<ContextNbtProvider> CODEC = RecordCodecBuilder.create((p_300408_) -> {
      return p_300408_.group(GETTER_CODEC.fieldOf("target").forGetter((p_300339_) -> {
         return p_300339_.getter;
      })).apply(p_300408_, ContextNbtProvider::new);
   });
   public static final Codec<ContextNbtProvider> INLINE_CODEC = GETTER_CODEC.xmap(ContextNbtProvider::new, (p_298349_) -> {
      return p_298349_.getter;
   });
