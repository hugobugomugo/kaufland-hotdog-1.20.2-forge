...
public class ChunkStatus {
   ...
   public static final ChunkStatus STRUCTURE_STARTS = register("structure_starts", EMPTY, 0, false, PRE_FEATURES, ChunkStatus.ChunkType.PROTOCHUNK, (p_296976_, p_296977_, p_296978_, p_296979_, p_296980_, p_296981_, p_296982_, p_296983_, p_296984_) -> {
      ...
      p_296978_.onStructureStartsAvailable(p_296984_);
      return CompletableFuture.completedFuture(Either.left(p_296984_));
   ...
   public static final ChunkStatus CARVERS = registerSimple("carvers", SURFACE, 8, POST_FEATURES, ChunkStatus.ChunkType.PROTOCHUNK, (p_296971_, p_296972_, p_296973_, p_296974_, p_296975_) -> {
      WorldGenRegion worldgenregion = new WorldGenRegion(p_296972_, p_296974_, p_296971_, 0);
      if (p_296975_ instanceof ProtoChunk protochunk) {
         Blender.addAroundOldChunksCarvingMaskFilter(worldgenregion, protochunk);
      }

      p_296973_.applyCarvers(worldgenregion, p_296972_.getSeed(), p_296972_.getChunkSource().randomState(), p_296972_.getBiomeManager(), p_296972_.structureManager().forWorldGenRegion(worldgenregion), p_296975_, GenerationStep.Carving.AIR);
   });
