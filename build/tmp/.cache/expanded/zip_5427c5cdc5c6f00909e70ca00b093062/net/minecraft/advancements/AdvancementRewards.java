...
public class AdvancementRewards {
   ...
   public void grant(ServerPlayer p_9990_) {
      ...
      this.function.get(minecraftserver.getFunctions()).ifPresent((p_296113_) -> {
         minecraftserver.getFunctions().execute(p_296113_, p_9990_.createCommandSourceStack().withSuppressedOutput().withPermission(2));
      });
   }
