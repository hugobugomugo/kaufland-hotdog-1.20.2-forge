...
public interface MinMaxBounds<T extends Number> {
   ...
   public static record Doubles(Optional<Double> min, Optional<Double> max, Optional<Double> minSq, Optional<Double> maxSq) implements MinMaxBounds<Double> {
      ...
      public static MinMaxBounds.Doubles fromJson(@Nullable JsonElement p_154792_) {
         return p_154792_ != null && !p_154792_.isJsonNull() ? Util.getOrThrow(CODEC.parse(JsonOps.INSTANCE, p_154792_), JsonParseException::new) : ANY;
      }
   ...
   public static record Ints(Optional<Integer> min, Optional<Integer> max, Optional<Long> minSq, Optional<Long> maxSq) implements MinMaxBounds<Integer> {
      ...
      public static MinMaxBounds.Ints fromJson(@Nullable JsonElement p_55374_) {
         return p_55374_ != null && !p_55374_.isJsonNull() ? Util.getOrThrow(CODEC.parse(JsonOps.INSTANCE, p_55374_), JsonParseException::new) : ANY;
      }
