...
public abstract class RecipeProvider implements DataProvider {
   ...
   protected static void generateForEnabledBlockFamilies(RecipeOutput p_300618_, FeatureFlagSet p_251836_) {
      BlockFamilies.getAllFamilies().filter((p_248034_) -> {
         ...
         generateRecipes(p_300618_, p_296363_);
      });
   }
   ...
   protected static void oreSmelting(RecipeOutput p_300202_, List<ItemLike> p_250172_, RecipeCategory p_250588_, ItemLike p_251868_, float p_250789_, int p_252144_, String p_251687_) {
      oreCooking(p_300202_, RecipeSerializer.SMELTING_RECIPE, p_250172_, p_250588_, p_251868_, p_250789_, p_252144_, p_251687_, "_from_smelting");
   }
   ...
   protected static void oreBlasting(RecipeOutput p_298528_, List<ItemLike> p_251504_, RecipeCategory p_248846_, ItemLike p_249735_, float p_248783_, int p_250303_, String p_251984_) {
      oreCooking(p_298528_, RecipeSerializer.BLASTING_RECIPE, p_251504_, p_248846_, p_249735_, p_248783_, p_250303_, p_251984_, "_from_blasting");
   }
   ...
   private static void oreCooking(RecipeOutput p_297621_, RecipeSerializer<? extends AbstractCookingRecipe> p_251817_, List<ItemLike> p_249619_, RecipeCategory p_251154_, ItemLike p_250066_, float p_251871_, int p_251316_, String p_251450_, String p_249236_) {
      for(ItemLike itemlike : p_249619_) {
         SimpleCookingRecipeBuilder.generic(Ingredient.of(itemlike), p_251154_, p_250066_, p_251871_, p_251316_, p_251817_).group(p_251450_).unlockedBy(getHasName(itemlike), has(itemlike)).save(p_297621_, getItemName(p_250066_) + p_249236_ + "_" + getItemName(itemlike));
      }
   ...
   protected static void cookRecipes(RecipeOutput p_298337_, String p_126008_, RecipeSerializer<? extends AbstractCookingRecipe> p_250529_, int p_126010_) {
      simpleCookingRecipe(p_298337_, p_126008_, p_250529_, p_126010_, Items.BEEF, Items.COOKED_BEEF, 0.35F);
      simpleCookingRecipe(p_298337_, p_126008_, p_250529_, p_126010_, Items.CHICKEN, Items.COOKED_CHICKEN, 0.35F);
      simpleCookingRecipe(p_298337_, p_126008_, p_250529_, p_126010_, Items.COD, Items.COOKED_COD, 0.35F);
      simpleCookingRecipe(p_298337_, p_126008_, p_250529_, p_126010_, Items.KELP, Items.DRIED_KELP, 0.1F);
      simpleCookingRecipe(p_298337_, p_126008_, p_250529_, p_126010_, Items.SALMON, Items.COOKED_SALMON, 0.35F);
      simpleCookingRecipe(p_298337_, p_126008_, p_250529_, p_126010_, Items.MUTTON, Items.COOKED_MUTTON, 0.35F);
      simpleCookingRecipe(p_298337_, p_126008_, p_250529_, p_126010_, Items.PORKCHOP, Items.COOKED_PORKCHOP, 0.35F);
      simpleCookingRecipe(p_298337_, p_126008_, p_250529_, p_126010_, Items.POTATO, Items.BAKED_POTATO, 0.35F);
      simpleCookingRecipe(p_298337_, p_126008_, p_250529_, p_126010_, Items.RABBIT, Items.COOKED_RABBIT, 0.35F);
   }
   ...
   private static void simpleCookingRecipe(RecipeOutput p_301359_, String p_249709_, RecipeSerializer<? extends AbstractCookingRecipe> p_251876_, int p_249258_, ItemLike p_250669_, ItemLike p_250224_, float p_252138_) {
      SimpleCookingRecipeBuilder.generic(Ingredient.of(p_250669_), RecipeCategory.FOOD, p_250224_, p_252138_, p_249258_, p_251876_).unlockedBy(getHasName(p_250669_), has(p_250669_)).save(p_301359_, getItemName(p_250224_) + "_from_" + p_249709_);
   }

   protected static void waxRecipes(RecipeOutput p_298400_) {
      HoneycombItem.WAXABLES.get().forEach((p_296357_, p_296358_) -> {
         ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, p_296358_).requires(p_296357_).requires(Items.HONEYCOMB).group(getItemName(p_296358_)).unlockedBy(getHasName(p_296357_), has(p_296357_)).save(p_298400_, getConversionRecipeName(p_296358_, Items.HONEYCOMB));
      });
   }
   ...
   protected static void generateRecipes(RecipeOutput p_299904_, BlockFamily p_176582_) {
      p_176582_.getVariants().forEach((p_176529_, p_176530_) -> {
         ...
         if (p_176529_ == BlockFamily.Variant.CRACKED) {
            smeltingResultFromBase(p_299904_, p_176530_, itemlike);
         }
   ...
   private static Criterion<InventoryChangeTrigger.TriggerInstance> inventoryTrigger(ItemPredicate... p_297226_) {
      return CriteriaTriggers.INVENTORY_CHANGED.createCriterion(new InventoryChangeTrigger.TriggerInstance(Optional.empty(), MinMaxBounds.Ints.ANY, MinMaxBounds.Ints.ANY, MinMaxBounds.Ints.ANY, List.of(p_297226_)));
   }
