...
public class RegistryCodecs {
   ...
   public static <T> Codec<Registry<T>> networkCodec(ResourceKey<? extends Registry<T>> p_206292_, Lifecycle p_206293_, Codec<T> p_206294_) {
      return withNameAndId(p_206292_, p_206294_.fieldOf("element")).codec().listOf().xmap((p_296330_) -> {
         MappedRegistry<T> mappedregistry = new MappedRegistry<>(p_206292_, p_206293_);

         for(RegistryCodecs.RegistryEntry<T> registryentry : p_296330_) {
            mappedregistry.registerMapping(registryentry.id(), registryentry.key(), registryentry.value(), p_206293_);
         }
