   ...
   public <A> Codec<A> wrapCodec(final Codec<A> p_300412_, final DataFixer p_297748_, final int p_299395_) {
      return new Codec<A>() {
         public <T> DataResult<T> encode(A p_299356_, DynamicOps<T> p_298710_, T p_298085_) {
            return p_300412_.encode(p_299356_, p_298710_, p_298085_).flatMap((p_299755_) -> {
               return p_298710_.mergeToMap(p_299755_, p_298710_.createString("DataVersion"), p_298710_.createInt(DataFixTypes.currentVersion()));
            });
         }
