...
public class AdvancementVisibilityEvaluator {
   ...
   private static boolean evaluateVisibility(AdvancementNode p_299221_, Stack<AdvancementVisibilityEvaluator.VisibilityRule> p_298849_, Predicate<AdvancementNode> p_265359_, AdvancementVisibilityEvaluator.Output p_265303_) {
   ...
   public static boolean isVisible(AdvancementNode advancement, Predicate<AdvancementNode> test) {
      ...
      return evaluateVisibility(advancement.root(), stack, test, (node, currentVis) -> {});
   }
